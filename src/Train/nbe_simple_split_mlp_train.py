...
from src.Networks.nbe_simple_mlp import NbeSimpleSplitMLP
...
class TrainConfig:
    ...
    # misc
    save_dir: str = "outputs/simple_split_mlp_train"
    seed: int = 42
...
def run_training(cfg: TrainConfig) -> None:
    ...
    for node_id in node_ids:
        ...
        # Always use NbeSimpleSplitMLP in this script
        ...
        for epoch in range(1, epochs + 1):
             ...
             for inputs, targets in train_loader:
                 ...
                 # No reshape here, NbeSimpleSplitMLP supports (Batch, Time, Feat)
                 # inputs: (B, T, F_in) -> outputs: (B, T, F_out)
...
@hydra.main(version_base=None, config_path="../../config/NBE", config_name="simple_split_mlp")
