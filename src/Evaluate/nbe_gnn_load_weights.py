...
def build_model_from_ckpt(
	ckpt: Dict[str, Any],
	model_ctor,  # callable to construct the model, e.g. NbeGNN
...
if __name__ == "__main__":
	...
	parser = argparse.ArgumentParser(description="Load best.pth recursively and attach to NbeGNN")
	...
	model, ckpt, path = load_model_from_dir(args.root_dir, NbeGNN, model_ctor_kwargs, map_location=device)
	if model is None:
